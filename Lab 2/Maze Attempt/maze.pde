...
void setup(){
  ...
  walls[0] = new Wall(new PVector(0, 0), new PVector(0, 0), new PVector(0.01, 0.10));  
  walls[1] = new Wall(new PVector(0, 0), new PVector(0, 0), new PVector(0.01, 0.10));  
...
class Wall { 
  ...
  Wall(PVector new_fWall, PVector new_penWall, PVector new_posWall){
